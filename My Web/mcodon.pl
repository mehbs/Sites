...
<html>
   ...
   <head>
      ...
      <link href="http://student.cryst.bbk.ac.uk/~pm001/css/mcodon.css" rel="stylesheet" type="text/css">
   </head>
   <!-- Body of Document -->
   <body>
      <header id="Heading">
      ...
      <div id="tablesection1">
         <!-- Table 1 With Colour And Headings for Codon, AA, Total Frequency All, Frequency For accession number   -->
