...
<html>
   <head>
      ...
      <link href="http://student.cryst.bbk.ac.uk/~pm001/css/mstickyend.css" rel="stylesheet" type="text/css">
   </head>
   <!-- Body of Document -->
   <body>
      <!-- Restriction Enzymes Cutting Sites Section Choose Cutting Site -->
      <section class='restriction'>
         <form action='http://student.cryst.bbk.ac.uk/cgi-bin/cgiwrap/pm001/sticky.pl'  method='post'>
      ...
      <div class='contentDetail'>
         ...
         <h1>Results</h1>
         <!--Results of Search -->
         <p>The Restriction Enzyme Cutting Sites, with sites highlighted in red, for <b>$accession</b> entry and the restriction enzyme <b>$string</b> (scroll across to see sites in sequence):
            $StickyEnds
         </p>
      </div>
      <!-- === end content div ===-->
