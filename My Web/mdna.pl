...
<html>
   <html>
      <head>
         ...
         <link href="http://student.cryst.bbk.ac.uk/~pm001/css/dna2.css" rel="stylesheet" type="text/css">
      </head>
      <body>
         ...
         <div class='contentDetail'>
            ...
            <p>The complete DNA sequence for <b>$accession</b> entry with coding regions highlighted in red : $GetDNA</p>
         </div>
         <!-- === end content div ===-->
      </body>
   </html>
